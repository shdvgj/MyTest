...
public class KMeansTest {
	...
	private Queue<NodeComparator> FsQueue = new PriorityQueue<NodeComparator>(10000, // 用来排序任意两点之间的距离，从大到小排
	...
	public void chooseCentroid(Queue<NodeComparator> queue) {
		...
		while (!queue.isEmpty()) {
			...
			System.out.println(nc.distance);
	...
	public static void main(String[] args) {
		...
		kmeans.setKmeansInput("in.txt");
		kmeans.printKmeansResults("out.txt");
